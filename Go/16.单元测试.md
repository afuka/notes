...
![单元测试1](/Users/afuka/Documents/Typora/Go/assert/单元测试1.png)
...
3. 示例函数提供了可以直接运行的示例代码，可以直接在`golang.org`的`godoc`文档服务器上使用`Go Playground`运行示例代码。下图为`strings.ToUpper`函数在Playground的示例函数效果。![Go Playground](/Users/afuka/Documents/Typora/Go/assert/单元测试2.png)